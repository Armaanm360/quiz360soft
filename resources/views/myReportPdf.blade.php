...
?>
                ...
                <div class="form-row Tableblock" data-id="1">
                    ...
                    <div class="form-group col-md-2">
                        <label for="Name">
                            {{str_replace("_"," ",$row) }} <span class="add addBlock" data-id="1" data-table="1"
                                style="color: rgb(3, 43, 3);cursor: pointer;"></span>
                        </label>
                        <div class="optionBox">
                            <div class="block_1">
                                @if ($row == 'select_user')
                                ...
                                @php
                                $dab = DB::table('users')->latest()->get();
                                @endphp
                                <select class="form-control select-2" id="select_user_name" name="" style="width: 100%">
                                ...
                                <input type="text" class="form-control" name="{{$row}}" id="name.0"
