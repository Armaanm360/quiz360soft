    ...
    <section>
        ...
        <div class="row p-5">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 p-0 mt-3 mb-2">
                ...
                <lottie-player src="https://assets3.lottiefiles.com/private_files/lf30_igfaivqx.json"
                    background="transparent" speed="1" style="width: 800px; height: 800px;" loop autoplay>
                </lottie-player>
            </div>
            ...
            @if ($user_info == 0)
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 text-center p-0 mt-3 mb-2">
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        <h3 class="text-white">বিভাগ : <button class="btn btn-danger text-white"
                                disabled>{{ $division }}</button></h3>
                        <h3 class="text-white">বিষয় : <button class="btn btn-success text-white"
                                disabled>{{ $subject_name }}</button></h3>
                        <h2><strong class="text-white" style="font-family:hindis_bold">কুইজ <span
                                    class="text-info">{{ $quiz_name }}</span> </strong></h2>
                        <p class="text-white">নিজেকে প্রস্তুত করো বুদ্ধিমূলক প্রশ্নের উত্তর
                            দিয়ে</p>
                        <h3> <button class="btn  btn-info text-white" disabled>
                                @if ($quiz_type == 'negetive')
                                    <i class="fa-solid fa-check"></i> Negative Marking
                                @endif
                            </button></h3>
                        <input type="hidden" id="timeid" value="{{ $quiz_time }}">
                        <div class="card text-white">
                            {{-- <strong id="timer">insert timer here</strong> --}}
                            <br /><em id="other">blah</em>
                        </div>
                                        ...
                                        <fieldset id="field_{{ $question->quiz_id }}">
                                            <div class="form-card">
                                                ...
                                                {{-- <h2 class="fs-title text-danger pt-3">
                                                    <span>{{ $bnNumber->bnNum($loop->index + 1) }}. </span>
                                            ...
                                            @else
                                                <input type="button" name="next"
                                                    id="nextid_{{ $question->quiz_id }}" class="next action-button"
                                                    value="Next Step" />
                                            @endif
                                        </fieldset>
                                    @endforeach
            ...
            @else
                <div class="col-sm-12 col-md-12 col-lg-6 text-center p-0 mt-3 mb-2">
                    <div class="card m-5">
                        ...
                        <input type="hidden" id="quiz_result_hour" value="{{ $quiz_result_hour }}">
                    </div>
                </div>
            @endif
