...
<script>
    ...
    $('#themeMode').on('click', function() {
        ...
        if (themeMode == 'white') {
            sendMode = 'dark';
            let themeMode = document.getElementById('themeMode').setAttribute('data-background-color',
                sendMode);
            document.getElementById('themeMode').innerHTML =
                '<i class="la flaticon-arrows-1"></i><span class="notif-img">Light Mode</span>';
        } else {
            sendMode = 'white';
            let themeMode = document.getElementById('themeMode').setAttribute('data-background-color',
                sendMode);
            document.getElementById('themeMode').innerHTML =
                '<i class="la flaticon-arrows-1"></i><span class="notif-img">Dark Mode</span>';
        }
        let sessMode = '';
        $.ajax({
            headers: {
    ...
    $(function() {
        ...
        $("#searchHeader").autocomplete({
                ...
                select: function(event, ui) {
                    ...
                    window.location.href = "{{ url('search') }}?section=" + ui.item.value +
                        '&&keywords=' + searchData;
                    return false;
                }
            })
