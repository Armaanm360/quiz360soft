...
class FormController extends Controller
{
    ...
    public function approvalCheck($user, $formid = null)
    {
        ...
        $data['formsupdate'] = DB::table('forms_info_all')->where('form_id', $formid)->where('form_created_by', $form_creator)->where('report_status', 'RECIEVED')->where('sender_id', Auth::user()->id)->where('receiver_category', Auth::user()->user_category)->update([
            'final_status' => true, 'feedback_msg' => null
        ]);
    ...
    public function generate_pdf_question($id)
    {
        $data = [
            'foo' => 'bar'
        ];
        ...
        $mpdf->writeHTML($this->pdfHTMLQuestion($id));
        return $mpdf->Output('question.pdf', 'D');
    ...
    public function generate_pdf_result($id)
    {
        $data = [
            'foo' => 'bar'
        ];
        ...
        $mpdf->writeHTML($this->pdfHTMLResult($id));
        return $mpdf->Output('result.pdf', 'D');
    ...
    public function generate_pdf_result_individual($id,$userid)
    {
        $data = [
            'foo' => 'bar'
        ];
        ...
        $mpdf->writeHTML($this->pdfHTMLResultIndividual($id,$userid));
        return $mpdf->Output('result.pdf', 'D');
    ...
    public function pdfHTMLQuestion($id)
    {
        $table_info = DB::table('subjective_quiz_table')->where('subjective_quiz_id', $id)->get();
        $data['quiz_name'] = $table_info[0]->subjective_quiz_name;
        $subject_id = $table_info[0]->subjective_sub_id;
        ...
        return view('myPDFques', $data);
    }
    public function pdfHTMLResult($id)
    {
        $table_info = DB::table('subjective_quiz_table')->where('subjective_quiz_id', $id)->get();
        $data['subject'] = $table_info[0];
        $answer_table = $table_info[0]->answer_table;
        $data['users_get'] = DB::table($answer_table)->orderBy('total_marks', 'desc')->get();

        return view('myPDFresult', $data);
    }

    public function pdfHTMLResultIndividual($id,$userid)
    {
        $table_info = DB::table('subjective_quiz_table')->where('subjective_quiz_id', $id)->get();
        $data['subject'] = $table_info[0];
        $answer_table = $table_info[0]->answer_table;
        ...
        return view('myPDFresultIndiv', $data);
    ...
    // {
    //     $data['question'] = DB::table('quiz_ques')->get();
    //     $data['question_count'] = DB::table('quiz_ques')->count();
    //     $data['question_first'] = DB::table('quiz_ques')->first();
    //     $data['question_last'] = DB::table('quiz_ques')->orderBy('id', 'desc')->first();
    //     return view('admin.pages.form.quiz', $data);
    // }

    /* test */
     public function quizForm($id)
    {

        $table_info = DB::table('subjective_quiz_table')->where('subjective_quiz_id', $id)->get();
        $data['quiz_name'] = $table_info[0]->subjective_quiz_name;
        $data['quiz_time'] = $table_info[0]->quiz_time;
        $data['quiz_type'] = $table_info[0]->quiz_type;
        $data['quiz_result_hour'] = $table_info[0]->quiz_result_hour;
        /* subject id get */
        $subject_id = $table_info[0]->subjective_sub_id;
        $get_subject = DB::table('college_subject')->where('college_sub_id',$subject_id)->get();
        $data['subject_name'] = $get_subject[0]->college_subject_name;
        ...
        $data['max'] = DB::table($answer_table)->max('total_marks');
        $data['fastest'] = DB::table($answer_table)->where('takentime','!=',0)->min('takentime');
        $data['contestent'] = DB::table($answer_table)->count();
        $all = DB::table($answer_table)->select('total_marks')->orderBy('total_marks', 'desc')->get();
        $all_arr = json_decode(json_encode($all, true), true);
        $all_values = array_column($all_arr, 'total_marks');
          

        if (isset($data['users_get'][0]->answerd_by) == Auth::user()->id) {
            $data['get_position'] = array_search($data['users_get'][0]->total_marks, $all_values);
            $takentime  =  $data['users_get'][0]->takentime; 
            $data['timetaken']  = number_format($takentime / 60, 2, ".", ".");
        ...
        $data['user_info'] = DB::table($answer_table)->where('answerd_by',Auth::user()->id)->count();
        $data['question'] = DB::table($question_table)->get();
        $data['question_count'] = DB::table($question_table)->count();
        $data['question_first'] = DB::table($question_table)->first();
        $data['question_last'] = DB::table($question_table)->orderBy('quiz_id', 'desc')->first();
        //return view('admin.pages.form.quiz', $data);
        return view('admin.pages.quiz.alternate_quiz', $data);
    }

    /* end test */
    public function reportQuiz()
    {
        $data['all_answers'] = DB::table('quiz_ques')->get();
        $data['ques_count'] = DB::table('quiz_ques')->count();
        $data['user_info'] = DB::table('quiz_ans')->where('new_user_id', Auth::user()->id)->get();
        return view('admin.pages.form.report_quiz', $data);
    }
    ...
    public function quizPost(Request $request)
    {
      ...
      foreach ($i as $icount) {
        ...
        //     echo '<pre>';
        // print_r($data['takentime']);die;


        // if (isset($get_type) == 'negetive') {
        //     $data['skipped_ans'] = $row_count - $answerd;
        //     $data['right_ans'] = $answerd - $wrong_answers;
        //     $data['wrong_ans'] = $wrong_answers;
        //     $wrong = $data['wrong_ans'] * 0.25;
        //     $right = $data['right_ans'] * 1;
        //     $data['total_marks'] = $right - $wrong;
        //     $data['takentime'] = $request->countquiztime;
    ...
    //  $dbuser = DB::table('quiz_ans')->where('new_user_id', Auth::user()->id)->count();
    ...
    public function createQuiz()
    {
        ...
        $data['quiz'] = DB::table('quiz_ques')->get();
        return view('admin.pages.form.create_quiz', $data);
    }
    ...
    public function createNewQuiz(Request $request)
    {
        ...
        $quiz = DB::table('quiz_ques')->insert([
    ...
    {
        $data['subject_card'] = DB::table('college_subject')->get();
        return view('admin.pages.form.quiz_home',$data);
    }

    public function homeStudentPanel()
    {
        return view('admin.pages.form.dashboard_student');
    }


    public function leaderBoard()
    {
        $data['unique'] = DB::table('quiz_ans')->distinct()->get(['new_user_id']);
        $object = json_decode(json_encode($data['unique']));
        $get_array = array_column($object, 'new_user_id');

        $data['users_get'] = DB::table('quiz_ans')->join('users', 'users.id', '=', 'quiz_ans.new_user_id')->orderBy('quiz_ans.total_marks', 'desc')->get();
        $data['first'] = DB::table('quiz_ans')->join('users', 'users.id', '=', 'quiz_ans.new_user_id')->orderBy('quiz_ans.total_marks', 'desc')->take(1)->latest()->get();




        return view('admin.pages.form.leaderboard', $data);
    }
     ...
     public function topLeads($quizid)
    {
        ...
        $data['top'] =  DB::table($answer_table[0]->answer_table)->orderBy('total_marks', 'DESC')->orderBy('takentime', 'ASC')->select(
        ...
        return view('admin.pages.form.frontend',$data);
